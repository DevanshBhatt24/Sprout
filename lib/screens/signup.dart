...
class _SignUpState extends State<SignUp> {
  ...
  void posturl(String username, String email, String password) async {
    if (_formkey.currentState!.validate()) {
      ...
      var response = await _session.post(
          "https://sprout-plant-care-app.herokuapp.com/user/register", data);
      // print(email);
      // print(username);
      // print(password);
      ...
      if (response['message'] == "Register successful") {
        ...
        setState(() {
          ...
          Navigator.of(context).push(
            CustomRoute(child: MainPage()),
          );
        });
      } else {
        Navigator.of(context).push(
          CustomRoute(child: SignUp()),
        );
        _fToast!.showToast(
            child: customToast(
  ...
  void kMovenext() {
    Navigator.push(context, CustomRoute(child: LogIn()));
  }
